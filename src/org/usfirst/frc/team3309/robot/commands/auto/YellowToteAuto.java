 ...
 * 
		...
		this.addParallel(new IntakeRunContinuous(3, 1, 50));
		this.addParallel(new IntakeOpenCommand(284));
		...
		this.addParallel(new IntakeOpenCommand(1422));
		this.addParallel(new MoveToteLiftUp(1600));

		this.addParallel(new IntakeRunContinuous(0, 1, 1636));
		this.addParallel(new IntakeCloseCommand(1813));
		
		
		this.addSequential(new DriveForwardEncoderCountsSlow(2062, Drive.getInstance().getAngle(), .27));
		
		this.addSequential(new TurnToAngle(70));
		
		this.addParallel( new MoveToteLiftDown(356));
		this.addParallel(new IntakeOpenCommand(391));
		this.addSequential(new DriveForwardEncoderCountsSlow(1600, 65, .7));
...
this.addParallel(new IntakeOpenCommand(550));
this.addSequential(new DriveForwardEncoderCountsSlow(2300, 65, .7));
