...
public class YellowTatersAuto extends CommandGroup {
	public YellowTatersAuto() {
		...
		this.addParallel(new MoveToteLiftUp(650));
		...
		this.addParallel(new MoveToteLiftDown(1500));
