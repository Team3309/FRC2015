...
public class YellowToteAutoAndTravel extends CommandGroup {
	...
	public YellowToteAutoAndTravel() {
		...
		this.addParallel( new MoveToteLiftDown(400));
		...
		this.addSequential(new DriveForwardEncoderCountsSlow(-100, 0, -.4));
		this.addParallel(new MoveToteLiftDown(-60));
		this.addParallel(new IntakeOpenCommand(-50));
		this.addSequential(new DriveForwardEncoderCountsSlow(-500, 0, -.4));
